...
def load_settings(settings):
    ...
    return patch_strategies, concretization_strategies, is_defects4j
...
def main(argv):
    ...
    patch_strategies, concretization_strategies, is_defects4j = load_settings(settings)
    ...
    while (1):
        print("=====================================")
        print("0. Quit")
        print("1. Mining New data")
        print("2. SPI model fitting")
        print("3. SPI model load")
        print("4. Settings")
        mainOption = int(input("What do you want to do? "))
        if (mainOption == 0):
            break
        elif (mainOption == 1):
            print("wow")
